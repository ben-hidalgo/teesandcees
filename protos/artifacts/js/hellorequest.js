...
goog.provide('proto.app.HelloRequest');
 ...
 * @return {!proto.app.HelloRequest} The clone.
 */
proto.app.HelloRequest.prototype.cloneMessage = function() {
  return /** @type {!proto.app.HelloRequest} */ (jspb.Message.cloneMessage(this));
};
