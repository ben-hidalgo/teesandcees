...
goog.provide('proto.app.HelloReply');
 ...
 * @return {!proto.app.HelloReply} The clone.
 */
proto.app.HelloReply.prototype.cloneMessage = function() {
  return /** @type {!proto.app.HelloReply} */ (jspb.Message.cloneMessage(this));
};
